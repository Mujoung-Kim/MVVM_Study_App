...
import company.domain.mvvmstudyapp.util.ApiException
...
class AuthViewModel(
    ...
    fun onLoginButtonClick(view: View) {
        ...
        Coroutines.main {
            ...
            if (response.isSuccessful) authListener?.onSuccess(response.body()?.user!!)
            else authListener?.onFailure("Error code: ${response.code()}")*/
    ...
    fun onSignupButtonClick(view: View) {
        ...
        Coroutines.main {
            try {
                val authResponse = repository.userSingup(name!!, email!!, password!!)
